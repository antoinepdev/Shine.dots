...
## Programs
### Terminal Emulators
- 👻 **Ghostty**: Manage tabs and splits easily (recommended if you don't use a window manager)
- 🐈 **Kitty**: Catppuccin theme, designed to work seamlessly with the **Hyprland** ecosystem.
...
### Text Editor
- 🦀 **Helix**: Modal edition, ultra fast, pre-configured with language servers, keymaps for a smooth editing experience.
  - Dependencies:
